...
function getNumberFromString(s) {
  return !isNaN(parseFloat(s))
    ? parseFloat(s)
    : "Couldn't extract a number from the provided string."; // Використовуємо функцію parseFloat для того, щоб спробувати отримати число з рядка
...
function getIntegerFromString(s) {
  return !isNaN(parseInt(s))
    ? parseInt(s)
    : "Couldn't extract an integer from the provided string."; // Використовуємо функцію parseInt для того, щоб спробувати отримати ціле число з рядка
  // Перевіряємо, чи є отримане значення числом за допомогою isNaN
